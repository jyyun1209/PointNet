...
class PointNet_wo_input_transform(nn.Module):
	def __init__(self, k=10):
		super(PointNet_wo_input_transform, self).__init__()
		self.name = 'PointNet_wo_input_transform'
